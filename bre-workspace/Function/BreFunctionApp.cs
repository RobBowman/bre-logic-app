...
namespace BizTalkers
{
    ...
    /// </summary>
    public class BreFunctionApp
    {
        private readonly ILogger<BreFunctionApp> logger;

        public BreFunctionApp(ILoggerFactory loggerFactory)
        {
            logger = loggerFactory.CreateLogger<BreFunctionApp>();
        }
